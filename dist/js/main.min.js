import Masonry from"masonry-layout";window.onload=()=>{var o=document.querySelector(".grid");new Masonry(o,{itemSelector:".grid-item"})};
...
$(document).ready(function(){$(".toggle-button").click(function(){$("body").toggleClass("showing")}),$(".toggle-button-close").click(function(){$("body").removeClass("showing")})});
...
$(".foot__scroll").click(function(){$("html, body").animate({scrollTop:0},1e3)});